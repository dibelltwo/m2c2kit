...
function makeDispositionName(itemId: string): string {
  return `${itemId}__disposition`;
}

function makePageForItem(
  item: EmaSurveyItem,
  surveyConfig: EmaSurveyConfig,
  index: number,
) {
...
function makeSliderElement(
  item: SliderSurveyItem,
  dispositionName: string,
): Record<string, unknown> {
  return {
...
function makeSingleChoiceElement(
  item: SingleChoiceSurveyItem,
  dispositionName: string,
): Record<string, unknown> {
  return {
    type: "radiogroup",
...
function makeMultiChoiceElement(
  item: MultiChoiceSurveyItem,
  dispositionName: string,
): Record<string, unknown> {
  return {
    type: "checkbox",
...
export function buildEmaSurveyJson(
  surveyConfig: EmaSurveyConfig,
